...
public class MultiShrinkLayout extends FrameLayout {
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            ...
            TitansLog.log(TAG, "oldScroll:" + oldScroll + " current:" + mScroller.getCurrY());
            final int delta = mScroller.getCurrY() - oldScroll;
            final int distanceFromMaxScrolling = getMaximumScrollUpwards() - getScroll();
            TitansLog.log(TAG, "computeScroll delta:" + delta + " distanceFromMaxScrolling:" + distanceFromMaxScrolling);
...
//        }
    ...
    private void stopDrag(boolean cancelled) {
        ...
        if (!cancelled && getChildCount() > 0) {
            ...
            TitansLog.log(TAG, "stopDrag velocity:" + velocity + " mMinimumVelocity:" + mMinimumVelocity);
    ...
    private void fling(float velocity) {
        ...
        TitansLog.log(TAG, "fling velocity:" + velocity);
